  ...
  return (
      <>
        ...
        <main className='mainContent'>
          ...
          <p>Hoje, a cotação do rublo russo (RUB) em relação ao real brasileiro (BRL) está em torno de R$ {props.cotacao} reais. Isso significa que para comprar 1 RUB, é necessário desembolsar cerca de R$ {props.cotacao} reais.</p><br/>
          <p>A taxa de câmbio do RUB pode variar ao longo do dia, dependendo de diversos fatores, como a oferta e demanda da moeda no mercado internacional, a política monetária do Banco Central da Rússia, a situação econômica da Rússia e de outros países, entre outros.</p><br/>
          <p>Para quem está planejando uma viagem para a Rússia ou para quem precisa realizar transações comerciais com parceiros russos, é importante acompanhar a cotação do RUB e realizar operações de câmbio no momento mais favorável, a fim de obter a melhor taxa possível.</p><br/>
          ...
          <p>É importante lembrar que a cotação apresentada aqui é apenas uma referência e pode variar ao longo do dia, por isso é necessário consultar fontes confiáveis e atualizadas para obter informações precisas sobre a cotação do RUB.</p>
          <Table cotacao={props.cotacao} moeda={'Rublo'} code={props.code} />
          <h2>Sobre o rublo russo</h2>
          <p>O rublo russo (RUB) é a moeda oficial da Federação Russa. Ele é emitido pelo Banco Central da Rússia e é amplamente utilizado em toda a Rússia como meio de troca para transações comerciais, bem como para o pagamento de serviços e impostos.</p><br/>
          <p>O RUB foi introduzido em 1998, substituindo o antigo rublo soviético. Desde então, o rublo tem enfrentado altos e baixos em sua trajetória no mercado internacional, influenciado principalmente pela situação econômica da Rússia e pelas políticas adotadas pelo Banco Central da Rússia.</p><br/>
          <p>Nos últimos anos, o rublo tem sido afetado por fatores externos, como as sanções econômicas impostas por alguns países ocidentais, bem como por fatores internos, como a queda do preço do petróleo, que é uma importante fonte de receita para a Rússia.</p><br/>
          <p>Apesar das flutuações na taxa de câmbio do RUB, ele ainda é amplamente utilizado como meio de troca na Rússia e em países vizinhos, e é uma moeda importante para transações comerciais internacionais com parceiros russos.</p><br/>
          <p>Para quem está planejando uma viagem para a Rússia ou para quem precisa realizar transações comerciais com parceiros russos, é importante acompanhar a cotação do RUB e realizar operações de câmbio no momento mais favorável, a fim de obter a melhor taxa possível.</p>
