  ...
  return (
      <>
        ...
        <main className='mainContent'>
          ...
          <p>A cotação do dólar hoje é de R$ {props.cotacao} reais. Isso significa que o preço de compra e venda do dólar americano está em R$ {props.cotacao} no mercado. A cotação do dólar é importante para diversas transações comerciais e a variação pode afetar a economia do país. Por isso, é importante estar sempre atento às mudanças na cotação do dólar para tomar decisões financeiras informadas.</p>
          <Table cotacao={props.cotacao} moeda={'Dólar'} code={props.code} />
          <h2>Sobre o dólar americano</h2>
          <p>O dólar americano é a moeda oficial dos Estados Unidos da América e também é a moeda de reserva mais amplamente utilizada em todo o mundo. O símbolo da moeda é "$" e o código ISO 4217 é "USD".</p><br/>
          <p>O dólar americano é emitido pelo Federal Reserve System, que é o banco central dos Estados Unidos. O Federal Reserve é responsável por definir a política monetária do país e controlar a oferta de dinheiro em circulação. O dólar americano é amplamente aceito em todo o mundo e é usado em transações comerciais internacionais, comércio e finanças.</p><br/>
          <p>A taxa de câmbio do dólar americano em relação a outras moedas é determinada pela oferta e demanda nos mercados cambiais. A força do dólar pode ser influenciada por vários fatores, como a saúde da economia americana, a política monetária do Federal Reserve, as condições econômicas globais e a política internacional.</p><br/>
          <p>Embora o dólar americano seja amplamente utilizado e respeitado em todo o mundo, também enfrenta alguns desafios. A inflação, a crescente dívida pública e a incerteza política podem afetar a força da moeda. Além disso, outras moedas, como o euro e o iene japonês, têm aumentado em popularidade nos últimos anos, desafiando a posição dominante do dólar americano como a principal moeda de reserva.</p><br/>
          <h2>Qual a diferença entre dólar comercial e dólar turismo?</h2>
          <p>O dólar comercial e o dólar turismo são dois tipos diferentes de cotação da moeda norte-americana em relação à moeda nacional de um país, como o Real brasileiro.</p><br/>
          <p>O <strong>dólar comercial</strong> é utilizado em transações comerciais entre empresas de diferentes países, como importações e exportações de bens e serviços. Essa cotação é definida pelo mercado financeiro e é influenciada por diversos fatores, como a oferta e demanda de dólares no mercado internacional, a taxa de juros dos países envolvidos na transação e as políticas econômicas adotadas pelos governos.</p><br/>
          <p>Já o <strong>dólar turismo</strong> é utilizado em transações de pessoas físicas em viagens ao exterior, como compras em lojas estrangeiras, pagamento de serviços turísticos, como hotéis e passeios, e saques em caixas eletrônicos no exterior. A cotação do dólar turismo é geralmente mais alta do que a do dólar comercial, já que inclui outras taxas, como a taxa de câmbio, impostos e tarifas de serviços bancários.</p><br/>
          <p>Em resumo, enquanto o dólar comercial é usado em transações entre empresas de diferentes países, o dólar turismo é usado em transações de pessoas físicas em viagens internacionais. A cotação do dólar turismo geralmente é mais alta do que a do dólar comercial, devido a taxas adicionais incluídas no preço final.</p>
