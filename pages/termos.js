    ...
    <>
      ...
      <div className="container_principal">
        <main className="mainContent">
          <h2>1. Termos</h2>
          <p>
            Ao acessar ao site <a href="/">Xmoedas.com.br</a> , concorda em
          ...
          <p>
            ...
            materiais (informações ou software) no site Xmoedas , apenas para
          ...
          <p>
            ...
            dessas restrições e poderá ser rescindida por Xmoedas a qualquer
          ...
          <ol>
            <li>
              Os materiais no site da Xmoedas são fornecidos 'como estão'.
              Xmoedas não oferece garantias, expressas ou implícitas, e, por
            ...
            <br />
            <li>
              Além disso, o Xmoedas não garante ou faz qualquer representação
          ...
          <h2>4. Limitações</h2>
          <p>
            Em nenhum caso o Xmoedas ou seus fornecedores serão responsáveis por
            ...
            da incapacidade de usar os materiais em Xmoedas , mesmo que Xmoedas
            ou um representante autorizado da Xmoedas tenha sido notificado
          ...
          <p>
            Os materiais exibidos no site da Xmoedas podem incluir erros
            técnicos, tipográficos ou fotográficos. Xmoedas não garante que
            qualquer material em seu site seja preciso, completo ou atual.
            Xmoedas pode fazer alterações nos materiais contidos em seu site a
            qualquer momento, sem aviso prévio. No entanto, Xmoedas não se
            compromete a atualizar os materiais.
          </p>
          <h2>6. Links</h2>
          <p>
            O Xmoedas não analisou todos os sites vinculados ao seu site e não é
            responsável pelo conteúdo de nenhum site vinculado. A inclusão de
            qualquer link não implica endosso por Xmoedas do site. O uso de
            qualquer site vinculado é por conta e risco do usuário.
          </p>
          <h2>Modificações</h2>
          <p>
            O Xmoedas pode revisar estes termos de serviço do site a qualquer
          ...
          <p>
            ...
            as leis do Xmoedas e você se submete irrevogavelmente à jurisdição
