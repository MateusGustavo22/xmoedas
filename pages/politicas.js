        ...
        <main className="mainContent">
          ...
          <p>
            <span style={{ color: '#252525' }}>
              A sua privacidade é importante para nós. É política do Xmoedas respeitar a sua privacidade em relação a
              qualquer informação sua que possamos coletar no site <a href="https://xmoedas.com.br">Xmoedas</a>, e
          ...
          <p>
            <span style={{ color: '#252525' }}>
              O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Xmoedas oferece no site e
          ...
          <ul>
            ...
            <li>
              <span style={{ color: '#252525' }}>
                C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Xmoedas, de seus
          ...
          <br />
          <p>
            <span style={{ color: '#252525' }}>Esta política é efetiva a partir de&nbsp;13 February 2023 01:33</span>
          </p>
          <br />
        </main>
      </div>
